...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            // 로그인 화면 이동
            $("#btnLogin").on("click", function () { // 버튼 클릭했을때, 발생되는 이벤트를 생성함(onclick 이벤트와 동일함)
...
<form id="f">
    <div class="divTable minimalistBlack">
        <div class="divTableBody">
            ...
            <div class="divTableRow">
                <div class="divTableCell">새로운 비밀번호 확인
                </div>
                <div class="divTableCell">
                    <input type="password" name="password2" id="password2" style=""/>
                </div>
            </div>
        </div>
    </div>
